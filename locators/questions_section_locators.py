...
class QuestionsSectionLocators:
    ...
    QUESTION_COST_PAYMENT = (By.ID, "//*[@id='accordion__heading-0']")
    # Ответ: "Сутки — 400 рублей. Оплата курьеру — наличными или картой."
    ANSWER_COST_PAYMENT = (By.XPATH, "// div[ @ id = 'accordion__panel-0'] / p")

    # Вопрос: "Хочу сразу несколько самокатов! Так можно?"
    QUESTION_MULTIPLE_SCOOTERS = (By.ID, "//*[@id='accordion__heading-1']")
    ...
    ANSWER_SCOOTER_CHARGER = (By.XPATH, "// div[ @ id = 'accordion__panel-5'] / p")

    # Вопрос: "Можно ли отменить заказ?"
    QUESTION_CANCEL_ORDER = (By.ID, "//*[@id='accordion__heading-6']")
    ...
    QUESTION_MKAD_DELIVERY = (By.ID, "//*[@id='accordion__heading-7']")
    # Ответ: "Да, обязательно. Всем самокатов! И Москве, и Московской области."
    ANSWER_MKAD_DELIVERY = (By.XPATH, "// div[ @ id = 'accordion__panel-7'] / p")
